...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'triangle.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'triangle.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'triangle.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "triangle.html.mem" : null;




var STATIC_BUMP = 6096;
...
Module.asmLibraryArg = { "abort": abort, "assert": assert, "enlargeMemory": enlargeMemory, "getTotalMemory": getTotalMemory, "abortOnCannotGrowMemory": abortOnCannotGrowMemory, "abortStackOverflow": abortStackOverflow, "nullFunc_ii": nullFunc_ii, "nullFunc_iiii": nullFunc_iiii, "nullFunc_vif": nullFunc_vif, "nullFunc_vi": nullFunc_vi, "invoke_ii": invoke_ii, "invoke_iiii": invoke_iiii, "invoke_vif": invoke_vif, "invoke_vi": invoke_vi, "_glUseProgram": _glUseProgram, "_eglGetDisplay": _eglGetDisplay, "_glDeleteShader": _glDeleteShader, "_glVertexAttribPointer": _glVertexAttribPointer, "_glGetProgramiv": _glGetProgramiv, "_abort": _abort, "_eglChooseConfig": _eglChooseConfig, "_glDrawArrays": _glDrawArrays, "_glGetProgramInfoLog": _glGetProgramInfoLog, "_emscripten_set_main_loop_timing": _emscripten_set_main_loop_timing, "_glDeleteProgram": _glDeleteProgram, "_XCreateWindow": _XCreateWindow, "_glLinkProgram": _glLinkProgram, "_glCreateProgram": _glCreateProgram, "_glViewport": _glViewport, "_XInternAtom": _XInternAtom, "___setErrNo": ___setErrNo, "_glClearColor": _glClearColor, "_eglSwapBuffers": _eglSwapBuffers, "_glClear": _glClear, "_emscripten_memcpy_big": _emscripten_memcpy_big, "_glutCreateWindow": _glutCreateWindow, "_XOpenDisplay": _XOpenDisplay, "_glGetShaderInfoLog": _glGetShaderInfoLog, "_eglCreateContext": _eglCreateContext, "_glBindAttribLocation": _glBindAttribLocation, "_glCreateShader": _glCreateShader, "_glShaderSource": _glShaderSource, "_eglInitialize": _eglInitialize, "_XMapWindow": _XMapWindow, "_XStoreName": _XStoreName, "_eglCreateWindowSurface": _eglCreateWindowSurface, "___syscall54": ___syscall54, "___unlock": ___unlock, "_glBindBuffer": _glBindBuffer, "_emscripten_set_main_loop": _emscripten_set_main_loop, "_eglWaitClient": _eglWaitClient, "_emscripten_get_now": _emscripten_get_now, "_glGenBuffers": _glGenBuffers, "_glAttachShader": _glAttachShader, "_eglGetConfigs": _eglGetConfigs, "_eglMakeCurrent": _eglMakeCurrent, "_glCompileShader": _glCompileShader, "_glEnableVertexAttribArray": _glEnableVertexAttribArray, "___lock": ___lock, "___syscall6": ___syscall6, "_glutInitDisplayMode": _glutInitDisplayMode, "_XChangeWindowAttributes": _XChangeWindowAttributes, "_XSetWMHints": _XSetWMHints, "_gettimeofday": _gettimeofday, "_glBufferData": _glBufferData, "_glGetShaderiv": _glGetShaderiv, "___syscall140": ___syscall140, "_XSendEvent": _XSendEvent, "___syscall146": ___syscall146, "DYNAMICTOP_PTR": DYNAMICTOP_PTR, "tempDoublePtr": tempDoublePtr, "ABORT": ABORT, "STACKTOP": STACKTOP, "STACK_MAX": STACK_MAX };
