...
var Runtime = {
    ...
    dynamicAlloc: function (size) { assert(DYNAMICTOP_PTR); var ret = HEAP32[DYNAMICTOP_PTR >> 2]; var end = (((ret + size + 15) | 0) & -16); HEAP32[DYNAMICTOP_PTR >> 2] = end; if (end >= TOTAL_MEMORY) {
...
var AllocMode;
(function (AllocMode) {
    AllocMode[AllocMode["ALLOC_NORMAL"] = 0] = "ALLOC_NORMAL";
    AllocMode[AllocMode["ALLOC_STACK"] = 1] = "ALLOC_STACK";
    AllocMode[AllocMode["ALLOC_STATIC"] = 2] = "ALLOC_STATIC";
    AllocMode[AllocMode["ALLOC_DYNAMIC"] = 3] = "ALLOC_DYNAMIC";
    AllocMode[AllocMode["ALLOC_NONE"] = 4] = "ALLOC_NONE";
})(AllocMode || (AllocMode = {}));
var ALLOC_NORMAL = 0;
var ALLOC_STACK = 1;
var ALLOC_STATIC = 2;
